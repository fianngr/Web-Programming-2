...
class Register extends CI_Controller {
    ...
    public function verify()
    {
        ...
        $this->form_validation->set_rules('phone_number', 'No. HP', 'numeric|required|min_length[9]|max_length[16]|is_unique[customers.phone_number]');
        $this->form_validation->set_rules('email', 'Email', 'valid_email|required|min_length[10]');
